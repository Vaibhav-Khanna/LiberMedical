...
namespace libermedical.CustomControls
{
    public class BasePage : ContentPage
    {
        ...
        public BasePage(int headerSize = -1, int footerSize = -1, bool hasNavigationBar = true)
        {
            ...
            _mainLayout.RowDefinitions.Add(new RowDefinition { Height = new GridLength(headerSize, GridUnitType.Absolute) });

            _mainLayout.RowDefinitions.Add(new RowDefinition { Height = new GridLength(1, GridUnitType.Star) });
            _mainLayout.RowDefinitions.Add(new RowDefinition { Height = new GridLength(footerSize, GridUnitType.Absolute) });
