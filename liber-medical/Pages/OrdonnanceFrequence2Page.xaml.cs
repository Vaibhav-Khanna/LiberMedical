...
namespace libermedical.Pages
{
    public partial class OrdonnanceFrequence2Page : BasePage
    {
        ...
        private async void UpdateListAsync()
        {
            ...
            if (items.Count == 0)
            {
                listCotations.HeightRequest = listCotations.HeightRequest = 0;
            }
            else
            {
                listCotations.HeightRequest = listCotations.HeightRequest = (listCotations.ItemsSource as ObservableCollection<string>).Count * 40 + 10;
            }
        }
        ...
        private void UpdateCotationsViewCellHeight(ObservableCollection<string> cotations)
        {
            Device.BeginInvokeOnMainThread(() =>
            {
                ...
                listCotations.HeightRequest = cotations.Count * 43;
